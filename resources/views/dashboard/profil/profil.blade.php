...
@section('container')
  <div class="row justify-content-center">
      <div class="col-xl-3">
          <div class="col-lg-12">
              ...
              <div class="card card-profil shadow text-center pb-3">
                  <img src="/asset/image/profil.jpg" class="rounded-4 mx-auto d-block mt-4 mb-2" alt="" width="191px" height="199px" alt="..." style="object-fit: cover;">
      ...
      <div class="col-xl-8">
          ...
          @endif
          <div class="py-2">
            <a href="/dashboard/profil/{{ $slug }}/edit" class="btn col-xl-2 col-12" style="background-color: #00B5D8; color: white;">Edit Data</a>
          </div>       
          <div class="row">
