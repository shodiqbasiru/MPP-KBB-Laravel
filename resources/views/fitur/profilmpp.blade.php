...
<body>
    <div class="container-fluid">
      <div class="row pt-2 mb-1">
        <div class="col-md-3">
          <a href="/">
            <img src="/asset/image/logo.png" class="mx-auto d-block" alt="" width="60px">
          </a>    
        </div>
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="/asset/image/slider1.jpg" class="d-block r-image mx-auto img-fluid rounded-4" height="300px" alt="...">
            </div>
            <div class="carousel-item">
              <img src="/asset/image/slider2.jpg" class="d-block r-image mx-auto img-fluid rounded-4" height="300px" alt="...">
            </div>
            <div class="carousel-item">
              <img src="/asset/image/slider3.jpg" class="d-block r-image mx-auto img-fluid rounded-4" height="300px" alt="...">
            </div>
          </div>
